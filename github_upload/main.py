...
loan_costs = [500, 600, 200, 1000, 450]
total_listed_loans = len(load_dynamic)
print(f"total number of loans (total_listed_loans)")
...
loan_costs = [500, 600, 200, 1000, 450]
average_loan_amount = total_of_loans / total_listed_loans
...
# YOUR CODE HERE!
pv =(present_value = future_value=1000, remaining_months=9, annual_discount_Rate=0.2)
present_value = 1000 / (1 + 0.2/12) ** 9
...
for "loan_price" <= 500 in loans:

if "loan_price" <= 500  inexpensive_loans.append:
